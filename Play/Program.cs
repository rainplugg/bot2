                     ...
                     if (play.player_1 == message.Chat.Id.ToString()) {
                        if (play.score_2 != "") {
                           while (true) {
                              ...
                              score_1 = rnd.Next(1, 6);
                              score_2 = rnd.Next(1, 6);
                              if (Convert.ToInt32(play.score_2.Split('|')[0]) + Convert.ToInt32(play.score_2.Split('|')[1]) != score_1 + score_2)
                                 break;
                           }
                        }
                        else {
                        ...
                        if (play.score_1 != "") {
                           while (true) {
                              ...
                              score_1 = rnd.Next(1, 6);
                              score_2 = rnd.Next(1, 6);
                              if (Convert.ToInt32(play.score_1.Split('|')[0]) + Convert.ToInt32(play.score_1.Split('|')[1]) != score_1 + score_2)
                                 break;
                           }
                        }
                        else {
                        ...
                        if ((Convert.ToInt32(play.score_1.Split('|')[0]) + Convert.ToInt32(play.score_1.Split('|')[1])) > (Convert.ToInt32(play.score_2.Split('|')[0]) + Convert.ToInt32(play.score_2.Split('|')[1]))) {
                           ...
                           if (user != null) {
                              ...
                              try {
                                 ...
                                 await client.EditMessageReplyMarkupAsync(play.player_1, msg1.MessageId, replyMarkup: null);
                                 await client.EditMessageReplyMarkupAsync(play.player_2, msg2.MessageId, replyMarkup: null);
                              } catch { }
                              return;
                           }
                        }
